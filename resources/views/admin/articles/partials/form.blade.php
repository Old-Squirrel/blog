...
<input type="text" class="form-control" name="image" placeholder="Автоматическая генерация"
...
<label for="">Раздел новости</label>
<input type="text" class="form-control" name="type" placeholder="Раздел новости"
       value="{{$article->type ?? ""}}">
